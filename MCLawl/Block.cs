...
namespace MCWorlds
{
    public class Block
    {
        ...
        //custom
        public const byte doorin = (byte)50;
        public const byte doorout = (byte)51;
        public const byte obsitrain = (byte)60;
        public const byte ascenseur = (byte)61;
            //redstone
        public const byte redstone_on = (byte)62;
        public const byte redstone_off = (byte)63;
        public const byte red_torche_on = (byte)64;
        public const byte red_torche_off = (byte)65;
            //piston
        public const byte piston_body = (byte)66;
        public const byte piston_middle = (byte)67;
        public const byte piston_push = (byte)68;
        public const byte piston_stick = (byte)69;
                ...
                else if (lines[0] == "#Version 2")
                {
                    ...
                    foreach (string line in lines)
                    {
                        if (line != "" && line[0] != '#')
                        {
                            ...
                            if (Byte(block[0]) == Zero)
                            {
                                continue;
                            }
                            newBlock.type = Byte(block[0]);
        ...
        public static void SaveBlocks(List<Blocks> givenList)
        {
            try
            {
                ...
                {
                    if (Name(bs.type).ToLower() != "unknown")
                    {
                        string line = Name(bs.type) + " : " + (int)bs.lowestRank + " : " + GrpCommands.getInts(bs.disallow) + " : " + GrpCommands.getInts(bs.allow);
                        w.WriteLine(line);
                    }
                }
                w.Flush();
        ...
        {
            if (type == op_water || portal(type) || mb(type)) return false;
        ...
        public static bool isRedstone(byte b)
        {
            switch (b)
            {
                case redstone_off:
        ...
        public static string Name(byte type)
        {
            switch (type)
            {
                ...
                case doorin: return "door_in";
                case doorout: return "door_out";
                case obsitrain: return "obsi_train";
                case ascenseur: return "ascenseur";
                case redstone_on: return "redstone_on";
                case redstone_off: return "redstone_off";
                case red_torche_on: return "redstone_torche_on";
                case red_torche_off: return "redstone_torche_off";
                case piston_body: return "piston_body";
                case piston_middle: return "piston_middle";
                case piston_push: return "piston_push";
                case piston_stick: return "piston_stick";
        ...
        public static byte Byte(string type)
        {
            switch (type.ToLower())
            {
                ...
                case "doorin":
                case "door_in" : return 50;
                case "doorout" :
                case "door_out": return 51;
                case "obsi_train": return obsitrain;
                case "ascenseur": return ascenseur;
                case "redstone_on": return redstone_on;
                case "redstone_off": return redstone_off;
                case "redstone_torche_on": return red_torche_on;
                case "redstone_torche_off": return red_torche_off;
                case "piston_body": return piston_body;
                case "piston_middle": return piston_middle;
                case "piston_push": return piston_push;
                case "piston_stick": return piston_stick;
        ...
        public static byte Convert(byte b)
        {
            switch (b)
            {
                case doorin: return white;
                case doorout: return 34; //black
                case obsitrain: return obsidian;
                case ascenseur: return red;
                case redstone_on: return red;
                case redstone_off: return white;
                case red_torche_on: return redmushroom;
                case red_torche_off: return mushroom;
                case piston_body: return lightgrey;
                case piston_middle: return mushroom;
                case piston_push: return yellow;
                case piston_stick: return lightgreen;
