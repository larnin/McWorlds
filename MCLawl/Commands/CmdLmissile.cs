...
namespace MCWorlds
{
    public class CmdLmissile : Command
    {
        public override string name { get { return "lmissile"; } }
        ...
        {
            Player.SendMessage(p, "/lmissile - Vous permet de tirer un missile lent.");
            Player.SendMessage(p, "sa vitesse est ma meme qu'un joueur");
        }
