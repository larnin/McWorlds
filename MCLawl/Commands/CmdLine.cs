...
namespace MCWorlds
{
    public class CmdLine : Command
    {
        ...
        {
            Player.SendMessage(p, "/line <num> <bloc> - Cree une ligne entre 2 blocs");
            Player.SendMessage(p, "<num> indique la longueur de la ligne (par raport au 1er point"); 
            Player.SendMessage(p, "/line <num> <bloc> wall - Crée un mur vertical sur la ligne");
        }
        ...
        public void Blockchange2(Player p, ushort x, ushort y, ushort z, byte type)
        {
            ...
            if (count > p.maxblocsbuild())
            {
                Player.SendMessage(p, "Vous essayez de faire une ligne de " + count + " blocs de long.");
                Player.SendMessage(p, "Vous etes limite a " + p.maxblocsbuild() + "blocs.");
                return;
            }
            ...
            Player.SendMessage(p, "La ligne a " + count.ToString() + " blocs de longeur.");
