    ...
    static class Scripting
    {
        ...
        public static void CreateNew(string CmdName)
        {
            ...
            sw.Write(
                ...
                Environment.NewLine +
                "\tUse this as a basis for custom commands implemented via the MCWorlds scripting framework." + Environment.NewLine +
                ...
                "// As a note, MCWorlds is designed for .NET 3.5." + Environment.NewLine +
                "using System;" + Environment.NewLine +
                Environment.NewLine +
                "namespace MCWorlds" + Environment.NewLine +
                "{" + Environment.NewLine +
                ...
                "\t\t}" + Environment.NewLine +
                Environment.NewLine +
                "\t\t// This one controls what happens when you use /help [commandname] [param/message]." + Environment.NewLine +
                "\t\tpublic override void Help(Player p, string message)" + Environment.NewLine +
                "\t\t{" + Environment.NewLine +
        ...
        /// </summary>
        /// <param name="name">String to convert to an MCWorlds class name.</param>
