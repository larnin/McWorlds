...
namespace MCWorlds.Gui
{
    public partial class PropertyWindow : Form
    {
        ...
        {
            txtExplode.Text = Server.killExplode;
            txtGas.Text = Server.killGas;
            txtWater.Text = Server.killWater;
            txtLava.Text = Server.killLava;
            txtMagma.Text = Server.killMagma;
            txtGeser.Text = Server.killGeser;
            txtPhoenix.Text = Server.killPhoenix;
            txtTrain.Text = Server.killTrain;
            txtLavaShark.Text = Server.killLavaShark;
            txtFire.Text = Server.killFire;
            txtRocket.Text = Server.killRocket;
            txtZombie.Text = Server.killZombie;
            txtCreeper.Text = Server.killCreeper;
            txtChute.Text = Server.killChute;
            txtNoyade.Text = Server.killNoyade;
            txtShark.Text = Server.killShark;
            txtKill.Text = Server.killKill;
        }
        public void SaveDeaths()
        {  
            Server.killExplode = txtExplode.Text;
            Server.killGas = txtGas.Text ;
            Server.killWater = txtWater.Text;
            Server.killLava = txtLava.Text;
            Server.killMagma = txtMagma.Text;
            Server.killGeser = txtGeser.Text;
            Server.killPhoenix = txtPhoenix.Text;
            Server.killTrain = txtTrain.Text;
            Server.killLavaShark = txtLavaShark.Text;
            Server.killFire = txtFire.Text;
            Server.killRocket = txtRocket.Text;
            Server.killZombie = txtZombie.Text;
            Server.killCreeper = txtCreeper.Text;
            Server.killChute = txtChute.Text;
            Server.killNoyade = txtNoyade.Text;
            Server.killShark = txtShark.Text;
            Server.killKill = txtKill.Text;
        ...
        public void Save(string givenPath) {
            try {
                ...
                if (givenPath.IndexOf("server") != -1) {
                    ...
                    w.WriteLine("#   max-player-maps\t=\tThe maximum number of maps a player can create");
                    ...
                    w.WriteLine("max-player-maps = " + txtPlayersMap.Text);
                    ...
                    if (Player.ValidName(txtMain.Text)) w.WriteLine("main-world = " + txtMainWorld.Text);
                    else w.WriteLine("main-world = main");
                    w.WriteLine();
                    ...
                    w.WriteLine("uncheap-message-given = " + txtUncheap.Text);
        ...
        private void txtMainWorld_TextChanged(object sender, EventArgs e) { /*removeDigit(txtMainWorld);*/ }
        private void txtBackup_TextChanged(object sender, EventArgs e) { removeDigit(txtBackup); }
        private void txtPlayersMap_TextChanged(object sender, EventArgs e) { removeDigit(txtBackup); }
        ...
        void saveStuff() {
            foreach (Control tP in tabControl.Controls)
                if (tP is TabPage && tP != tabPage3 && tP != tabPage5 && tP != tabPage6) 
                    foreach (Control ctrl in tP.Controls)
                        if (ctrl is TextBox) 
                            if (ctrl.Text == "" && ctrl.Name != "txtStatut") {
...
#region rankTab
        ...
        private void listRanks_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtStatut.Text = foundRank.statut;
        ...
        {
            if (txtStatut.Text.Length > 16)
            { txtStatut.Text = txtStatut.Text.Substring(0, 16); }
            storedRanks[listRanks.SelectedIndex].statut = txtStatut.Text;
        }
...
#region DeathsTab
        private void txtExplode_TextChanged(object sender, EventArgs e) { }
        ...
        private void txtMagma_TextChanged(object sender, EventArgs e) { }
        private void txtGeser_TextChanged(object sender, EventArgs e) { }
        private void txtPhoenix_TextChanged(object sender, EventArgs e) { }
        private void txtTrain_TextChanged(object sender, EventArgs e) { }
        private void txtLavaShark_TextChanged(object sender, EventArgs e) { }
        private void txtFire_TextChanged(object sender, EventArgs e) { }
        private void txtRocket_TextChanged(object sender, EventArgs e) { }
        private void txtZombie_TextChanged(object sender, EventArgs e) { }
        private void txtCreeper_TextChanged(object sender, EventArgs e) { }
        private void txtChute_TextChanged(object sender, EventArgs e) { }
        private void txtNoyade_TextChanged(object sender, EventArgs e) { }
        private void txtShark_TextChanged(object sender, EventArgs e) { }
        private void txtKill_TextChanged(object sender, EventArgs e) { }
#endregion
