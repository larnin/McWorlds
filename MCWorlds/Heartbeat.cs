...
namespace MCWorlds
{
    ...
    retry:  try
            {
                ...
                switch (type)
                {
                    ...
                    /*case Beat.TChalo:
                        ...
                        worlds = "";
                        for (int i = 0; i < Server.levels.Count; i++) { worlds += Server.levels[i].name + ","; }

                        postVars += "&worlds=" + worlds.Substring(0, worlds.Length - 1); // changement
                        postVars += "&motd=" + UrlEncode(Server.motd) +
                                ...
                                "&server=MCWorlds" +
                                "&details=Running MCWorlds version " + Server.Version;
   ...
   retryStream: try
    ...
    public enum Beat { Minecraft/*, TChalo, MCWorlds*/ }
}
