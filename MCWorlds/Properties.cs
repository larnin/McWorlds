                ...
                foreach (string line in lines)
                {
                    if (line != "" && line[0] != '#')
                    {
                        ...
                        switch (key.ToLower())
                        {
                            ...
                            case "max-player-maps":
                                {
                                    try
                                    {
                                        ...
                                        {
                                            value = "100";
                                            Server.s.Log("Max players maps has been lowered to 100.");
                                        }
                                        else if (Convert.ToByte(value) < 1)
                                        {
                                            value = "1";
                                            Server.s.Log("Max players maps has been increased to 1.");
                                        }
                                        Server.maxPlayerMaps = Convert.ToByte(value);
                                    }
                                    catch
                                    {
                                        Server.s.Log("max-maps invalid! setting to default.");
                                        Server.maxPlayerMaps = 5;
                                    }
                                    break;
                                }
                            case "irc":
                            ...
                            case "main-world":
                                {
                                    if (Player.ValidName(value)) Server.mainWorld = value;
                                    else Server.s.Log("Invalid main world name");
                                    break;
                                }
        ...
        static void Save(string givenPath)
        {
            try
            {
                ...
                if (givenPath.IndexOf("server") != -1)
                {
                    ...
                    w.WriteLine("max-player-maps = " + Server.maxPlayerMaps.ToString());
                    ...
                    w.WriteLine("main-world = " + Server.mainWorld);
                    w.WriteLine();
