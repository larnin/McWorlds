...
namespace MCWorlds
{
    public class CmdWrite : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            Player.SendMessage(p, "Place 2 blocs pour determiner la direction.");
            p.ClearBlockchange();
            p.Blockchange += new Player.BlockchangeEventHandler(Blockchange1);
        }
        public override void Help(Player p, string message = "")
        {
            Player.SendMessage(p, "/write [message] - Ecrit le message en blocs");
        }
        ...
        public void Blockchange2(Player p, ushort x, ushort y, ushort z, byte type)
        {
            ...
            if (x == cpos.x && z == cpos.z) { Player.SendMessage(p, "Pas de direction selectionne"); return; }
