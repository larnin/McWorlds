...
namespace MCWorlds
{
    public class CmdOutline : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            if (type2 == 255) { Player.SendMessage(p, "Il n'existe pas de bloc \"" + t2 + "\"."); return; }
            if (!Block.canPlace(p, type2)) { Player.SendMessage(p, "Impossible de placer ce bloc."); return; }
        ...
        {
            Player.SendMessage(p, "/outline [type] [type2] - Permet de placer une couche de [type2] sur [type]");
        }
        ...
        public void Blockchange2(Player p, ushort x, ushort y, ushort z, byte type)
        {
            ...
            {
                Player.SendMessage(p, "Vous avez essayer de surligner " + buffer.Count + " blocs.");
                Player.SendMessage(p, "Vous ne pouvez pas surligner plus de " + p.maxblocsbuild() + ".");
                return;
            }
            ...
            Player.SendMessage(p, "Vous surlignez " + buffer.Count + " blocs.");
